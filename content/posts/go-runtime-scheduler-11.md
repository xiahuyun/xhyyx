...
date = 2024-09-17T10:15:38+08:00
categories = ["go"]
...
![status process](/images/go-runtime-status-process.jpg)

大部分转移路径前面几讲也介绍过，这里就不继续介绍了(下同)。

接着是 P 的状态转移图：

![P status process](/images/go-p-status-process.jpg)

最后是线程 M 的状态转移图：

![M status process](/images/go-m-status-process.jpg)
...
![GPM process](/images/go-gpm-process.jpg)

（*这个图来自资深 Gopher 曹大，他的网站在 [这里](https://xargin.com/)，推荐哦*）

## 调度流程

![schedule process](/images/go-schedule-process.jpg)
